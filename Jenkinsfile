pipeline {
    agent any
    parameters {
        text(name: 'bundle_version', description: 'See the list of <a href="https://s3-eu-west-1.amazonaws.com/synapticon-tools/firmwares/odb.json">released bundles</a>, or the list of <a href="https://s3.amazonaws.com/oblac-drives/index.html">built VMs</a>.');
        text(name: 'oblac_drives_version', defaultValue: 'latest');
        text(name: 'motion_master_version', defaultValue: '', description: 'Specify the motion-master version from <a href="https://s3-eu-west-1.amazonaws.com/synapticon-tools/motion-master/release/index.html">directory listing</a>. If left empty a binary will be copied from the motion-master Jenkins job.');
